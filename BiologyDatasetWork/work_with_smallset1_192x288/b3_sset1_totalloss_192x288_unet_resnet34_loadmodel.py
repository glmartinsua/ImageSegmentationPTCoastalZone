...
model = load_model('models\\sset1_totalloss_192x288_unet_res34_50epochs.hdf5', compile=False)
...
model.load_weights('models\\sset1_totalloss_192x288_unet_res34_50epochs.hdf5')
...
# loss:  0.8335989713668823  # -> Loss function diferente (weighted total_loss)
# iou_score:  0.7084118127822876
# f1-score:  0.7844687700271606
# mean_iou:  0.41161978244781494 (???)
...
# IoU for class1 (background) is:  0.9179034632167804
# IoU for class2 (water) is:  0.8890128955542116
# IoU for class3 (mussels) is:  0.2871613288243485
"""
