...
model = load_model('models\\b3_sset1_totalloss_192x288_unet_res34_50epochs.hdf5', compile=False)
...
model.load_weights('models\\b3_sset1_totalloss_192x288_unet_res34_50epochs.hdf5')
'''
...
TEST_IMG_DIR = 'C:\@Dissertacao\datasets\FotosBiologia\Galapos\Voo 2\Galapos43.JPG'
