...
model = load_model('models\\512aug_gen_192x288_unet_res34_50epochs.hdf5', compile=False)
...
model.load_weights('models\\512aug_gen_192x288_unet_res34_50epochs.hdf5')
...
# loss:  0.2094622403383255
# iou_score:  0.6099393963813782
# f1-score:  0.6359304189682007
# mean_iou:  0.33443883061408997 (???)
...
# IoU for class1 (background) is:  0.9222600700295219
# IoU for class2 (water) is:  0.8581978581426887
