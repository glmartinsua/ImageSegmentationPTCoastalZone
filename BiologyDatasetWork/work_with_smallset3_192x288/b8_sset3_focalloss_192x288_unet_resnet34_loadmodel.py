...
#model = load_model('models/b8_sset3_192x288_focalloss_unet_res34_50epochs.hdf5', compile=False)
...
model.load_weights('models/b8_sset3_192x288_focalloss_unet_res34_50epochs.hdf5')
...
# loss:  0.004982589744031429
# iou_score:  0.7062720060348511
# f1-score:  0.7998287677764893
# mean_iou:  0.33426329493522644 (???)
...
# IoU for class1 (background) is:  0.7529923992584158
# IoU for class2 (water) is:  0.9361081485771597
# IoU for class3 (mussels) is:  0.4136923986717009
