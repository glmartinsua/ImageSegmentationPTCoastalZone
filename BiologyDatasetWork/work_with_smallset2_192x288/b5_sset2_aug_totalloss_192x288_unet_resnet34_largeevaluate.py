...
# model = load_model('models/b5_sset2_aug_totalloss_192x288_unet_res34_50epochs.hdf5', compile=False)
...
model.load_weights('models/b5_sset2_aug_totalloss_192x288_unet_res34_50epochs.hdf5')
...
''' Galapos6 '''
# results (in metrics order): [0.9378891587257385, 0.5059431195259094, 0.5611742734909058, 0.33740678429603577]
# Mean IoU = 0.43912092
# IoU for class1 (0) is:  0.3772042216248225
# IoU for class2 (1) is:  0.9401586048218981
# IoU for class3 (2) is:  0.0
